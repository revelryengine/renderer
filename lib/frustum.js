...
/**
 * @typedef {import('../deps/gltf.js').Node & { camera: import('../deps/gltf.js').Camera }} CameraNode
...
export class Frustum extends UBO.Layout({
    ...
    gridModelMatrix:          { type: 'mat4x4<f32>' },
    gridViewProjectionMatrix: { type: 'mat4x4<f32>' },
    ...
    /**
     * @overload
     * @param {{ graph: import('./graph.js').Graph, cameraNode: CameraNode, jitter?: boolean }} options
     * @return {void}
     *
     * @overload
     ...
     * @return {void}
     *
     * @param {{ graph?: import('./graph.js').Graph, cameraNode?: CameraNode, transform?: mat4, projectionMatrix?: mat4, jitter?: boolean }} options
     */
