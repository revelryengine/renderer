...
export function generate({ flags, locations }) {
    ...
    const code = /* glsl */`
        ...
        #pragma revTextureBinding(envLUT, 2, ${bindGroup.envLUT}, 0)
        uniform sampler2D envLUT;
        
        #pragma revTextureBinding(envGGX, 2, ${bindGroup.envGGX}, 0)
        uniform samplerCube envGGX;

        #pragma revTextureBinding(envCharlie, 2, ${bindGroup.envCharlie}, 0)
