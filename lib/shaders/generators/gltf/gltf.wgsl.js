...
export function generate({ flags, locations }) {  
    ...
    const fragment = /* wgsl */`
        ...
        fn main(input: FragmentInput) -> FragmentOutput {
            ...
            ${flags.outputColor || flags.outputPoint ? /* wgsl */`
                normalInfo = getNormalInfo();
            ` : ''}

            ${flags.outputPoint ? /* wgsl */`
            ...
            ${flags.outputColor && flags.colorWriteMask ? /* wgsl */`
                ...
                ` : /* wgsl */`
                    ...
                    ${flags.isBlend ? /* wgsl */`
                        var weight = alphaWeightEq10(in.gl_FragCoord.z, out.color.a);

                        out.accum  = vec4<f32>(out.color.rgb * weight, out.color.a);
                        out.reveal = out.color.a * weight;
                    `: ''}
