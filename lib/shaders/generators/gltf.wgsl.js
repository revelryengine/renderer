...
export function generate({ flags, locations }) {  
    ...
    const vertex = /* wgsl */`
        ...
        ${frustumUniformBlock}
        ${flags.useShadows ? lightingUniformBlock : ''}
        ...
        fn main(input: VertexInput) -> VertexOutput {
            ...
            ${flags.useShadows ? /* wgsl */`
                out.shadowTexcoords0 = lighting.shadowMatrices[0] * pos;
                out.shadowTexcoords1 = lighting.shadowMatrices[1] * pos;
                out.shadowTexcoords2 = lighting.shadowMatrices[2] * pos;
                out.shadowTexcoords3 = lighting.shadowMatrices[3] * pos;
                out.shadowTexcoords4 = lighting.shadowMatrices[4] * pos;
                out.shadowTexcoords5 = lighting.shadowMatrices[5] * pos;
            `: ''}
    ...
    if(!flags.shadowPass) {
        fragment = /* wgsl */`
            ...
            fn main(input: FragmentInput) -> FragmentOutput {
                ...
                ${flags.storePointInfo ? /* wgsl */`
                    out.point = vec4<f32>(in.gl_FragCoord.z, normalize((mat3x3<f32>(frustum.viewMatrix[0].xyz, frustum.viewMatrix[1].xyz, frustum.viewMatrix[2].xyz) * normalInfo.n * 0.5) + 0.5));
                `: ''}
