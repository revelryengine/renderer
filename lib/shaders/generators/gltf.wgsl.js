...
export function generate({ flags, locations }) {  
    ...
    const fragment = /* wgsl */`
        ...
        fn main(input: FragmentInput) -> FragmentOutput {
            ...
            ${flags.storePointInfo ? /* wgsl */`
            out.point = vec4<f32>(in.gl_FragCoord.z * 0.5 + 0.5, normalize((mat3x3<f32>(frustum.viewMatrix[0].xyz, frustum.viewMatrix[1].xyz, frustum.viewMatrix[2].xyz) * normalInfo.n * 0.5) + 0.5));
            `: ''}
