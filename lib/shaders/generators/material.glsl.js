...
export function generate({ flags, locations }) {
    ...
    const textureUVBlock = (name) => {
        let uv = glsl`material.${name}UVSet == 1 ? v_texCoord1 : v_texCoord0`;
    ...
    const code = glsl`
        ...
        NormalInfo getNormalInfo() {
            ...
            vec3 t_ = (uv_dy[1] * dFdx(v_position) - uv_dx[1] * dFdy(v_position)) /
            ...
            ${flags.hasTexture?.normalTexture ? glsl`
                ...
                n = n * vec3(material.normalScale, material.normalScale, 1.0);
        ...
        MaterialInfo getMaterialInfo() {
            ...
            ${flags.hasExtension?.KHR_materials_clearcoat ? glsl`
                ...
                materialInfo.clearcoatF0        = vec3(materialInfo.f0);
                ...
                ${flags.hasTexture?.['KHR_materials_clearcoat.clearcoatNormalTexture'] ? glsl`
                    ...
                    n = n * vec3(material.KHR_materials_clearcoat.clearcoatNormalScale, material.KHR_materials_clearcoat.clearcoatNormalScale, 1.0);
