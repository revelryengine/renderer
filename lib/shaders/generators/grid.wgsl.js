...
export function generate() {
    ...
    const fragment = /* wgsl */`
        ...
        fn main(in: VertexOutput) -> FragmentOutput {
            ...
            var lod0_cross_a = 1.0 - abs(saturateVec2(mod2(center, lod0_cs) / dudv) * 2.0 - 1.0);
            var lod0_a = max(lod0_cross_a.x, lod0_cross_a.y);
        
            var lod1_cross_a = 1.0 - abs(saturateVec2(mod2(center, lod1_cs) / dudv) * 2.0 - 1.0);
            var lod1_a = max(lod1_cross_a.x, lod1_cross_a.y);
            
            var lod2_cross_a = 1.0 - abs(saturateVec2(mod2(center, lod2_cs) / dudv) * 2.0 - 1.0);
