...
export function generate({ flags, locations }) {
    ...
    const code = /* wgsl */`
        [[group(0), binding(0)]] var modelTexture: texture_2d_array<f32>;
        
        [[group(0), binding(1)]] var jointTexture: texture_2d_array<f32>;
        
        [[group(0), binding(2)]] var morphTexture: texture_2d_array<f32>;
