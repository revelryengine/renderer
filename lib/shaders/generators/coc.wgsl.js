...
`;
    ...
    const fragment = /* wgsl */`
        ...
        fn main(in: VertexOutput) -> FragmentOutput {
            ...
            var dist = getLinearDepth(textureSample(depthTexture, depthSampler, in.texCoord) * 0.5 + 0.5); // depth texture is in the wrong range see https://bugs.chromium.org/p/dawn/issues/detail?id=1187
