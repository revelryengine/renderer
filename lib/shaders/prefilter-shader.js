...
export class PrefilterShader extends Shader {
    ...
    constructor(gal, { view, format, distribution, roughness, sampleCount }) {
        super(gal, { distribution, roughness, sampleCount, lodBias: 0 });
        ...
        this.bindGroup = gal.device.createBindGroup({
            ...
            entries: [
                ...
                { binding: 0, resource: gal.device.createSampler({ magFilter: 'linear', minFilter: 'linear', mipmapFilter: 'linear' }) },
