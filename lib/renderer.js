...
export class Renderer {
    ...
    /**
     * @template {Revelry.Renderer.RenderPathKeys} [T='standard']
     * @param {{ target: import('./viewport.js').ViewportTarget } & Revelry.Renderer.RenderPathSettingsOptions<T>} options
     */
