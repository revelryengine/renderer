...
export class GLTFShader extends Shader {
    ...
    getFlags() {
        ...
        const flags = {
            ...
            useShadows        : settings.flags.punctual && settings.flags.shadows,
        ...
        Object.assign(flags, {
            ...
            writeMasks: {
                color: flags.isBlend && (settings.flags.alphaBlendMode === 'weighted') ? 0 : 0xF,
                blend: flags.isBlend && (settings.flags.alphaBlendMode === 'weighted') ? 0xF : 0,
            },
