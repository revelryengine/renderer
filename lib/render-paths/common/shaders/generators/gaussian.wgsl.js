...
export function generate({ flags: { bilateral } }) {
    ...
    const fragment = /* wgsl */`
        ...
        ${Gaussian.generateUniformBlock('wgsl', 0, 2)}
        ...
        const sampleCount   = 3;
        const colorSamples  = array<f32, 3>(0.0, 1.3846153846, 3.2307692308);
        const gaussianCoeff = array<f32, 3>(0.2270270270, 0.3162162162, 0.0702702703);
        ...
        fn main(in: VertexOutput) -> FragmentOutput {
            ...
            var offsetScale = gaussian.direction * texelSize;
