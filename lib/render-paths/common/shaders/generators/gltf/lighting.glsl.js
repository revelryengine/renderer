...
export function generate(shader) {
    ...
    const code = /* glsl */`
        ...
        ${flags.useEnvironment  ? generateEnvironmentBlock(shader): ''}
        ${flags.useTransmission ? generateTransmissionBlock(shader): ''}
        ${flags.usePunctual     ? generatePunctualBlock(shader): ''}
