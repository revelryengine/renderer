...
export function generate({ flags, locations, input: { settings } }) {
    ...
    const lightingMode = {
        ...
        `,
        solid: /* glsl */`
            g_finalColor = vec4(linearTosRGB(material.baseColorFactor.rgb * dot(normalInfo.n, normalInfo.v) * 0.8), 1.0);
        `,
        preview: /* glsl */`
            g_finalColor = vec4(linearTosRGB(materialInfo.baseColor.rgb * dot(normalInfo.n, normalInfo.v) * 0.8), materialInfo.baseColor.a);
        `,
        wireframe: /* glsl */`
