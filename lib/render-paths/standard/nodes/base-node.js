...
class BaseGLTFShader extends GLTFShader {
    getFlags(...args) {
        ...
        return {
            ...
            colorTargets: {
                color:  flags.colorTargets.color && settings.enabled.transmission,
                blend:  flags.colorTargets.blend && settings.enabled.transmission,
                point:  settings.enabled.ssao,
                id:     settings.enabled.passiveInput
            },
