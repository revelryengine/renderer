...
class BloomExtractNode extends RenderNode {
    ...
    reconfigure({ color }) {
        super.reconfigure();
        this.bloomShader = new BloomShader(this.gal, { settings: this.renderPath.settings, color }).compile();
    }
...
export class BloomNode extends RenderNode {
    ...
    reconfigure({ color }) {
        ...
        this.bloomShader = new BloomShader(this.gal, { settings: this.renderPath.settings, color, bloom: this.blurNode.output.color, mode: 'mix' }).compile();
