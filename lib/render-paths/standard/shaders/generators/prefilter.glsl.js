...
import generateFormulasBlock from '../../../common/shaders/generators/formulas.glsl.js';
...
export function generate({ input: { sampleCount, distribution = 0, lodBias = 0 } }) {
    ...
    const fragment = /* glsl */`#version 300 es
        ...
        ${Prefilter.generateUniformBlock('glsl', 1, 0)}
        ...
        vec3 filterColor(vec3 N) {
            vec3  color  = vec3(0.0);
            float weight = 0.0;
            float roughness = prefilter.roughness;
