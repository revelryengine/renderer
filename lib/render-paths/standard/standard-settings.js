...
export class StandardSettings extends RenderPathSettings {
    ...
    flags = {
        ...
        tonemap:        /** @type {keyof import('../../constants.js').PBR_TONEMAPS|null}*/(null),
        debugPBR:       /** @type { keyof import('../../constants.js').PBR_DEBUG_MODES | 'None'} */('None'),
        debugAABB:      false,
    ...
    get temporal() {
        return !!(this.flags.motionBlur || this.flags.taa);
    }
}
