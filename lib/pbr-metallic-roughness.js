...
export class PBRMetallicRoughness extends GLTFProperty {
   ...
   */
  dereference(root) {
    if (this.baseColorTexture) this.baseColorTexture.dereference(root);
    if (this.metallicRoughnessTexture) this.metallicRoughnessTexture.dereference(root);
  }
   ...
   */
  rereference(root) {
    if (this.baseColorTexture) this.baseColorTexture.rereference(root);
    if (this.metallicRoughnessTexture) this.metallicRoughnessTexture.rereference(root);
  }
}
