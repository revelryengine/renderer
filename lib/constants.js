 ...
 *
 * @type {(
 *  Record<GPUVertexFormat|GPUIndexFormat, { webgl2: { normalized: boolean, integer: boolean, type: number, size: number } }> &
 *  Record<'gltf', { normalized: Record<number, GPUVertexFormatPrefix>, unnormalized: Record<number, GPUVertexFormatPrefix> }>
 * )}
 */
...
export const DEFAULT_DEPTH_PARAMS = {
    enabled           : true,
    format            : 'depth24plus',
    depthClearValue   : 1,
    depthStoreOp      : 'store',
