...
export const BUFFER_USAGE = GPUBufferUsage || { 
    MAP_READ      : 0x0001,
    MAP_WRITE     : 0x0002,
    COPY_SRC      : 0x0004,
    COPY_DST      : 0x0008,
...
export const TEXTURE_USAGE = GPUTextureUsage  || {
    COPY_SRC          : 0x01,
    COPY_DST          : 0x02,
...
export const MAP_MODE = GPUMapMode || {
    READ  : 0x0001,
    WRITE : 0x0002,
};


export const SHADER_STAGE = GPUShaderStage || {
    VERTEX   : 0x1,
    FRAGMENT : 0x2,
    COMPUTE  : 0x4,
};

export const COLOR_WRITE = GPUColorWrite || {
    RED   : 0x1,
    GREEN : 0x2,
    BLUE  : 0x4,
    ALPHA : 0x8,
...
export const VERTEX_FORMAT = {
    'uint8x2':   { bytes:  2, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_BYTE, size: 2 } },
    'uint8x4':   { bytes:  4, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_BYTE, size: 4 } },
    'sint8x2':   { bytes:  2, webgl2: { normalized: false, integer: true,  type: GL.BYTE, size: 2 } },
    'sint8x4':   { bytes:  4, webgl2: { normalized: false, integer: true,  type: GL.BYTE, size: 4 } },
    'unorm8x2':  { bytes:  2, webgl2: { normalized: true,  integer: false, type: GL.UNSIGNED_BYTE, size: 2 } },
    'unorm8x4':  { bytes:  4, webgl2: { normalized: true,  integer: false, type: GL.UNSIGNED_BYTE, size: 4 } },
    'snorm8x2':  { bytes:  2, webgl2: { normalized: true,  integer: false, type: GL.BYTE, size: 2 } },
    'snorm8x4':  { bytes:  4, webgl2: { normalized: true,  integer: false, type: GL.BYTE, size: 4 } },
    'uint16':    { bytes:  2, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_SHORT, size: 1 } },
    'uint16x2':  { bytes:  4, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_SHORT, size: 2 } },
    'uint16x4':  { bytes:  8, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_SHORT, size: 4 } },
    'sint16x2':  { bytes:  4, webgl2: { normalized: false, integer: true,  type: GL.SHORT, size: 2 } },
    'sint16x4':  { bytes:  8, webgl2: { normalized: false, integer: true,  type: GL.SHORT, size: 4 } },
    'unorm16x2': { bytes:  4, webgl2: { normalized: true,  integer: true,  type: GL.UNSIGNED_SHORT, size: 2 } },
    'unorm16x4': { bytes:  8, webgl2: { normalized: true,  integer: true,  type: GL.UNSIGNED_SHORT, size: 4 } },
    'snorm16x2': { bytes:  4, webgl2: { normalized: true,  integer: true,  type: GL.SHORT, size: 2 } },
    'snorm16x4': { bytes:  8, webgl2: { normalized: true,  integer: true,  type: GL.SHORT, size: 4 } },
    'float16x2': { bytes:  4, webgl2: { normalized: false, integer: false, type: GL.HALF_FLOAT, size: 2 } },
    'float16x4': { bytes:  8, webgl2: { normalized: false, integer: false, type: GL.HALF_FLOAT, size: 4 } },
    'float32':   { bytes:  4, webgl2: { normalized: false, integer: false, type: GL.FLOAT, size: 1 } },
    'float32x2': { bytes:  8, webgl2: { normalized: false, integer: false, type: GL.FLOAT, size: 2 } },
    'float32x3': { bytes: 12, webgl2: { normalized: false, integer: false, type: GL.FLOAT, size: 3 } },
    'float32x4': { bytes: 16, webgl2: { normalized: false, integer: false, type: GL.FLOAT, size: 4 } },
    'uint32':    { bytes:  4, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_INT, size: 1 } },
    'uint32x2':  { bytes:  8, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_INT, size: 2 } },
    'uint32x3':  { bytes: 12, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_INT, size: 3 } },
    'uint32x4':  { bytes: 16, webgl2: { normalized: false, integer: true,  type: GL.UNSIGNED_INT, size: 4 } },
    'sint32':    { bytes:  4, webgl2: { normalized: false, integer: true,  type: GL.INT, size: 1 } },
    'sint32x2':  { bytes:  8, webgl2: { normalized: false, integer: true,  type: GL.INT, size: 2 } },
    'sint32x3':  { bytes: 12, webgl2: { normalized: false, integer: true,  type: GL.INT, size: 3 } },
    'sint32x4':  { bytes: 16, webgl2: { normalized: false, integer: true,  type: GL.INT, size: 4 } },
...
export const PBR_DEBUG_MODES = {
    ...
    'NormalInfo View': { 
        wgsl: /* wgsl */`out.color = vec4<f32>((normalInfo.v + 1.0) / 2.0, 1.0);`,
        glsl: glsl`g_finalColor = vec4((normalInfo.v + 1.0) / 2.0, 1.0);`
    },
