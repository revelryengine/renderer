...
export class Node extends NamedGLTFProperty {
   ...
   */
  dereference() {
    super.dereference('camera', 'cameras');
    super.dereference('skin', 'skins');
    super.dereference('mesh', 'meshes');
    super.dereference('children', 'nodes');
  }
   ...
   */
  rereference() {
    super.rereference('camera', 'cameras');
    super.rereference('skin', 'skins');
    super.rereference('mesh', 'meshes');
    super.rereference('children', 'nodes');
  }
}
