...
export class Node extends NamedGLTFProperty {
   ...
   */
  dereference(root) {
    this.dereferenceFromCollection('camera', root.cameras);
    this.dereferenceFromCollection('skin', root.skins);
    this.dereferenceFromCollection('mesh', root.meshes);
    this.dereferenceFromCollection('children', root.nodes);
   ...
   */
  rereference(root) {
    this.rereferenceFromCollection('camera', root.cameras);
    this.rereferenceFromCollection('skin', root.skins);
    this.rereferenceFromCollection('mesh', root.meshes);
    this.rereferenceFromCollection('children', root.nodes);
