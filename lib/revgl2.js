...
class RevGL2RenderPipeline extends RevGL2ObjectBase {
    ...
    async #getProgramAsync(descriptor) {
        ...
        let program = RevGL2RenderPipeline.getProgramFromCache(vertex.module, fragment.module);
        ...
        if(!program) {
            ...
            RevGL2RenderPipeline.addProgramToCache(vertex.module, fragment.module, program);
        }
