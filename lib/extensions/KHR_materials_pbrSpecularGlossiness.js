...
import { GLTFProperty, extensions, TextureInfo } from '../webgltf.js';
...
export class KHRMaterialsPBRSpecularGlossinessMaterial extends GLTFProperty {
   ...
   */
  dereference(root) {
    if (this.diffuseTexture) this.diffuseTexture.dereference(root);
    if (this.specularGlossinessTexture) this.specularGlossinessTexture.dereference(root);
   ...
   */
  rereference(root) {
    if (this.diffuseTexture) this.diffuseTexture.rereference(root);
    if (this.specularGlossinessTexture) this.specularGlossinessTexture.rereference(root);
