...
export class KHRMaterialsSpecularMaterial extends GLTFProperty {
    ...
    */
    ...
    static textureFields = ['specularTexture', 'specularColorTexture'];
    static uniformFields = { 
        specularFactor:      'u_KHR_materials_specular_specularFactor',
        specularColorFactor: 'u_KHR_materials_specular_specularColorFactor',
    }
    
    static defines = { MATERIAL_SPECULAR: 1 };
}
