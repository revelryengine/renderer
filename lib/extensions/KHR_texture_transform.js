...
import { mat3, mat4   } from '../utils/gl-matrix.js';
...
export class KHRTextureTransform extends GLTFProperty {
  ...
  getTransformMat4(){
    ...
    transformMat4[ 0] = transform[0];
    transformMat4[ 1] = transform[1];
    transformMat4[ 2] = transform[2];

    transformMat4[ 4] = transform[3];
    transformMat4[ 5] = transform[4];
    transformMat4[ 6] = transform[5];

    transformMat4[ 8] = transform[6];
    transformMat4[ 9] = transform[7];
    transformMat4[10] = transform[8];
