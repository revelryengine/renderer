 ...
 *
 * @see {@link https://github.com/KhronosGroup/glTF/tree/master/specification/2.0#accessor|Accessor}
 * @see {@link https://github.com/KhronosGroup/glTF/tree/master/specification/2.0#accessorx|AccessorX}
 */
...
export class Accessor extends NamedGLTFProperty {
  ...
  constructor(accessor, root) {
     ...
     * @type {BufferView}
     */
    this.bufferView = root.bufferViews[bufferView];
