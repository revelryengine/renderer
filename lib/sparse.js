...
export class Sparse extends NamedGLTFProperty {
  ...
  constructor(sparse, root) {
     ...
     * @type {Indices}
     */
    this.indices = new Indices(indices, root);
     ...
     * @type {Values}
     */
    this.values = new Values(values, root);
  }
   ...
   */
  dereference() {
    this.indices.dereference();
    this.values.dereference();
  }
   ...
   */
  rereference() {
    this.indices.rereference();
    this.values.rereference();
  }
}
