...
/********** morphing.glsl.js **********/
  ...
  attribute vec3 a_Target_0_POSITION;
#endif

#ifdef HAS_TARGET_1_POSITION
  attribute vec3 a_Target_1_POSITION;
#endif

#ifdef HAS_TARGET_2_POSITION
  attribute vec3 a_Target_2_POSITION;
#endif

#ifdef HAS_TARGET_3_POSITION
  attribute vec3 a_Target_3_POSITION;
#endif

#ifdef HAS_TARGET_4_POSITION
  attribute vec3 a_Target_4_POSITION;
#endif

#ifdef HAS_TARGET_5_POSITION
  attribute vec3 a_Target_5_POSITION;
#endif

#ifdef HAS_TARGET_6_POSITION
  attribute vec3 a_Target_6_POSITION;
#endif

#ifdef HAS_TARGET_7_POSITION
  attribute vec3 a_Target_7_POSITION;
#endif

#ifdef HAS_TARGET_0_NORMAL
  attribute vec3 a_Target_0_NORMAL;
#endif

#ifdef HAS_TARGET_1_NORMAL
  attribute vec3 a_Target_1_NORMAL;
#endif

#ifdef HAS_TARGET_2_NORMAL
  attribute vec3 a_Target_2_NORMAL;
#endif

#ifdef HAS_TARGET_3_NORMAL
  attribute vec3 a_Target_3_NORMAL;
#endif

#ifdef HAS_TARGET_0_TANGENT
  attribute vec3 a_Target_0_TANGENT;
#endif

#ifdef HAS_TARGET_1_TANGENT
  attribute vec3 a_Target_1_TANGENT;
#endif

#ifdef HAS_TARGET_2_TANGENT
  attribute vec3 a_Target_2_TANGENT;
#endif

#ifdef HAS_TARGET_3_TANGENT
  attribute vec3 a_Target_3_TANGENT;
#endif
