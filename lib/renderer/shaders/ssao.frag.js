...
uniform sampler2D u_PointSampler; //contains z and normal
...
vec3 getPosFromDepth(vec2 coord, float depth) {
    vec4 clip = u_Frustum.invProjectionMatrix * vec4(vec3(coord, depth) * 2.0 - 1.0, 1.0);
...
{   
    ...
    for(int i = 0; i < SSAO_KERNEL_SIZE; ++i)
    {
        ...
        offset      = u_Frustum.projectionMatrix * offset;    // from view to clip-space
