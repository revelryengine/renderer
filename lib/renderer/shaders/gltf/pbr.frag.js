...
/************  @modification-fog [1/2]****************/
#ifdef USE_FOG
uniform vec4 u_FogColor;
uniform vec2 u_FogRange; // min max
#endif
/************  /@modification-fog [1/2]****************/
...
/************  @modification-ssao [2/2] ****************/
    ...
    vec2 uv = gl_FragCoord.xy / u_ViewportDimensions;
...
/************ @modification-debug-normal-view ****************/
    ...
    vec3 debugN = normalize(transpose(inverse(mat3(u_ViewMatrix))) * n);
...
/************  @modification-base [2/2]****************/
    /** @todo: move some of this math to the vertex shader or cpu */
    #ifdef BASE_PASS
        vec3 viewN = normalize(transpose(inverse(mat3(u_ViewMatrix))) * n);
        g_z = vec4(gl_FragCoord.z, (viewN * 0.5 + 0.5));
        g_ids = v_PrimitiveId;
    #endif
/************  /@modification-base [2/2]****************/
}
