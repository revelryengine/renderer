...
vec3 getDefaultF0() {
  vec3 f0 = vec3(0.04);
    ...
    f0 = 0.08 * vec3(u_KHR_materials_specular_specularFactor);
      ...
      f0 *= SRGBtoLINEAR(texture2D(u_KHR_materials_specular_specularTexture, getKHRMaterialsSpecularUV())).a;
    #endif
  #endif
...
void main() {
  ...
  vec3 f0 = getDefaultF0();
      ...
      vec4 sgSample = SRGBtoLINEAR(texture2D(u_KHR_materials_pbrSpecularGlossiness_specularGlossinessTexture, getKHRMaterialsPBRSpecularGlossinessSpecularGlossinessUV()));
      ...
      baseColor = SRGBtoLINEAR(texture2D(u_KHR_materials_pbrSpecularGlossiness_diffuseTexture, getKHRMaterialsPBRSpecularGlossinessDiffuseUV())) * u_KHR_materials_pbrSpecularGlossiness_diffuseFactor;
    #else
