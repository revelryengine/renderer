 ...
 * 
 * Modifications:
 * - @modification-base-pass Added support for outputing position and normals to textures
...
/************  /@modification-ssao [2/2] ****************/
    ...
    // g_finalColor = vec4(vec3(v_Position.z / 10.0 * 0.5 + 0.5), 1.0);
#endif
