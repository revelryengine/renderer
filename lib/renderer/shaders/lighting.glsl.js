...
// See our README.md on Environment Maps [3] for additional discussion.
  ...
  vec3 getIBLContributionX(MaterialInfo materialInfo, vec3 n, vec3 v) {
    float NdotV = clamp(dot(n, v), 0.0, 1.0);
    ...
    vec4 diffuseSample = textureCube(u_diffuseEnvTexture, n);

  #ifdef USE_TEX_LOD
    vec4 specularSample = textureCubeLodEXT(u_specularEnvTexture, reflection, lod);
  #else
    vec4 specularSample = textureCube(u_specularEnvTexture, reflection);
  #endif
