...
export class AnimationSampler extends GLTFProperty {
   ...
   */
  dereference(root) {
    this.dereferenceFromCollection('input', root.accessors);
    this.dereferenceFromCollection('output', root.accessors);
   ...
   */
  rereference(root) {
    this.rereferenceFromCollection('input', root.accessors);
    this.rereferenceFromCollection('output', root.accessors);
    super.dereference(root);
  }
}
