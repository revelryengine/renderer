...
import { WeakCache, roundUp } from '../deps/utils.js';
...
* @typedef {{ offset: number, count: number, primitive: import('../deps/gltf.js').MeshPrimitive, frontFace: 'cw'|'ccw', instances: mat4[] }} InstanceBatch
...
* @typedef {{  offset: number, primitive: import('../deps/gltf.js').MeshPrimitive, frontFace: 'cw'|'ccw', depth: number }} SortedInstanceBlock
*
