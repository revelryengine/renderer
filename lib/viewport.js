...
/**
 * @template {Revelry.Renderer.RenderPathKeys} [T=any]
 */
export class Viewport {
    /**
     * @param {import('./revgal.js').RevGAL} gal
     * @param {{ target: ViewportTarget, renderPath: T } & Revelry.Renderer.RenderPathSettingsOptions<T>} options
     */
    ...
    /**
     * @param {Revelry.Renderer.RenderPathSettingsFlags<T>} [flags]
     * @param {Revelry.Renderer.RenderPathSettingsValues<T>} [values]
     */
    ...
    /**
     * @param {(
     *  { graph: Graph, cameraNode: ViewportCameraNode, filter?: ConstructorParameters<typeof GameObjectFilter>[0] } & Revelry.Renderer.RenderPaths[T]['options']
     * )} options
     */
