...
export class Skin extends NamedGLTFProperty {
   ...
   */
  dereference(root) {
    super.dereference('inverseBindMatrices', root.accessors);
    super.dereference('skeleton', root.nodes);
    super.dereference('joints', root.nodes);
  }
   ...
   */
  rereference(root) {
    super.rereference('inverseBindMatrices', root.accessors);
    super.rereference('skeleton', root.nodes);
    super.rereference('joints', root.nodes);
  }
}
