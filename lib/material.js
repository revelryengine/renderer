        ...
        for (const name in this.textures) {
            ...
            if (texture) {
                ...
                if(KHR_texture_transform){
                    if(KHR_texture_transform.texCoord !== undefined) this[`${name}UVSet`] = KHR_texture_transform.texCoord;
                    this[`${name}UVTransform`] = UBO.std140Mat3(KHR_texture_transform.getTransform());
                }
            }
        }
            ...
            for(const texName in ext) {
                if(texName.endsWith('Texture')){
                    ...
                    if(texture) {
                        ...
                        const { KHR_texture_transform } = texture.extensions;
                        if(KHR_texture_transform){
                            if(KHR_texture_transform.texCoord !== undefined) this[extName][`${texName}UVSet`] = KHR_texture_transform.texCoord;
                            this[extName][`${texName}UVTransform`] = UBO.std140Mat3(KHR_texture_transform.getTransform());
                        }
