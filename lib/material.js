...
export class Material extends UBO {
    static layout = new UBO.Layout([
        ...
        { name: 'normalTextureScale',                  type: 'f32'         },
        ...
        { name: 'KHR_materials_clearcoat', type: 'KHR_materials_clearcoat', layout: [
                ...
                { name: 'clearcoatNormalTextureScale',          type: 'f32'         },
        ...
        { name: 'KHR_materials_iridescence', type: 'KHR_materials_iridescence', layout: [
                { name: 'iridescenceFactor',           type: 'f32' },
                { name: 'iridescenceIor',              type: 'f32' },
                { name: 'iridescenceThicknessMinimum', type: 'f32' },
                { name: 'iridescenceThicknessMaximum', type: 'f32' },

                { name: 'iridescenceTextureUVSet',                type: 'i32'         },
                { name: 'iridescenceTextureUVTransform',          type: 'mat3x3<f32>' },
                { name: 'iridescenceThicknessTextureUVSet',       type: 'i32'         },
                { name: 'iridescenceThicknessTextureUVTransform', type: 'mat3x3<f32>' },
            ],
        },

        { name: 'KHR_materials_emissive_strength', type: 'KHR_materials_emissive_strength', layout: [
    ...
    constructor(gal, material = {}) {
        ...
        const { doubleSided, alphaMode } = material;
    ...
    upload() {
        ...
        this.normalTextureScale = normalTexture?.scale,
            ...
            for(const texName in ext) {
                if(texName.endsWith('Texture')){
                    ...
                    if(texture) {
                        ...
                        if(texture.scale) this[extName][`${texName}Scale`] = texture.scale;
